...
const BowlingFirst = () => {
    ...
    //   }
     ...
     function checkOut() {
      if(systemLastRun === lastRunDefended && systemLastRun!=0 && lastRunDefended!=0){
  ...
  return (
    <>
    {displayContent && (<>
    <p className='bowlingfirstpara'>OPPONENT'S LAST INPUT:<span className='score'>  {systemLastRun}</span></p>
    <p className='bowlingfirstpara'>YOUR'S LAST INPUT:<span className='score'>  {lastRunDefended}</span></p>
    <p className='opponentscore'>OPPONENT'S SCORE<span className='score'> {systemScore}</span></p>
    <div className='bowlingfirstbuttonrow'>
        <button className='bowlingfirstbutton' onClick={() => HandleClick('1')}>1</button>
        <button className='bowlingfirstbutton' onClick={() => HandleClick('2')}>2</button>
        <button className='bowlingfirstbutton' onClick={() => HandleClick('3')}>3</button>
        <button className='bowlingfirstbutton' onClick={() => HandleClick('4')}>4</button>
        <button className='bowlingfirstbutton' onClick={() => HandleClick('5')}>5</button>
        <button className='bowlingfirstbutton' onClick={() => HandleClick('6')}>6</button>
        {/* <button onClick={() => HandleClick('dot')}>dot</button> */}
    </div></>)}
    {
        !displayContent && (<Wickettaken 
          runstowin = {systemScore - systemLastRun +1}/>)
    }
