...
const Battingsecond = ({systemScoreToDefend}) => {
  ...
  return (
    <>
      {displayContent && (
        <>
          <p className="secondbattingpara">
            OPPONENT'S LAST INPUT: <span className="score"> {systemScore}</span>
          </p>
          <p className="secondbattingpara">
            YOUR LAST INPUT: <span className="score"> {lastRunScored}</span>
          </p>
          <p className="secondbattingtotalscore">
            YOU NEED <span className="score"> {scoreToWin}</span> RUNS TO WIN{' '}
          </p>
          <div className="secondbattingbuttonrow">
            <button
              className=" secondbattingbutton"
