...
const SelectBattingorBowling = () => {
  ...
  useEffect(() => {}, [displayContent, userChoiceInput])

  return (
    <>
      {displayContent && (
        <>
          <p className="paratag">YOU WON THE TOSS.!</p>
          <p className="paratag">CHOOSE YOUR PICK</p>
          <div className="optingdiv">
            <button
              className="optingbutton"
              onClick={() => HandleSelectChoice('battingFirst')}>
              Batting
            </button>
            <button
              className="optingbutton"
              onClick={() => HandleSelectChoice('battingsecond')}>
              Bowling
            </button>
          </div>
        </>
